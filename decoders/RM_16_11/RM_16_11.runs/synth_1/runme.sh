...
HD_PWD='C:/LRMLD/decoders/RM_16_11/RM_16_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_top.tcl
