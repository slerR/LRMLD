...
HD_PWD='C:/LRMLD/decoders/RM_16_11/RM_16_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_top.tcl -notrace
