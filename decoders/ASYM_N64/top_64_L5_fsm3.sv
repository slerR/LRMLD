module top_64 #(
    ...
    logic [40 - 1 : 0] m_c_32_48_m [0 : N_COS - 1];
    logic [80 - 1 : 0] m_c_32_48_l [0 : N_COS - 1];
    logic              m_c_32_48_v;

    logic [40 - 1 : 0] m_c_48_64_m [0 : N_COS - 1];
    logic [80 - 1 : 0] m_c_48_64_l [0 : N_COS - 1];
    logic              m_c_48_64_v;
    ...
    logic [40 - 1 : 0] m_c_16_32_m [0 : N_COS - 1];
    logic [80 - 1 : 0] m_c_16_32_l [0 : N_COS - 1];
    logic              m_c_16_32_v;

    logic [40 - 1 : 0] m_c_32_64_m [0 : N_COS - 1];
    logic [160 - 1 : 0] m_c_32_64_l [0 : N_COS - 1];
    logic              m_c_32_64_v;
    ...
    logic [40 - 1 : 0] m_c_16_64_m [0 : N_COS - 1];
    logic [240 - 1 : 0] m_c_16_64_l [0 : N_COS - 1];
    logic              m_c_16_64_v;
    ...
    logic [40 - 1 : 0] m_c_8_64_m [0 : N_COS - 1];
    logic [280 - 1 : 0] m_c_8_64_l [0 : N_COS - 1];
    logic              m_c_8_64_v;
    ...
    logic [40 - 1 : 0] m_c_4_64_m [0 : N_COS - 1];
    logic [300 - 1 : 0] m_c_4_64_l [0 : N_COS - 1];
    logic              m_c_4_64_v;
    ...
    logic [40 - 1 : 0] d_16_32_to_16_64_m [0 : N_COS - 1];
    logic [80 - 1 : 0] d_16_32_to_16_64_l [0 : N_COS - 1];
