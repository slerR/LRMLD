module top_64 #(
    ...
    logic [128 - 1 : 0] m_c_32_48_m [0 : N_COS - 1];
    logic [256 - 1 : 0] m_c_32_48_l [0 : N_COS - 1];
    logic              m_c_32_48_v;

    logic [128 - 1 : 0] m_c_48_64_m [0 : N_COS - 1];
    logic [256 - 1 : 0] m_c_48_64_l [0 : N_COS - 1];
    logic              m_c_48_64_v;
    ...
    logic [128 - 1 : 0] m_c_16_32_m [0 : N_COS - 1];
    logic [256 - 1 : 0] m_c_16_32_l [0 : N_COS - 1];
    logic              m_c_16_32_v;

    logic [128 - 1 : 0] m_c_32_64_m [0 : N_COS - 1];
    logic [512 - 1 : 0] m_c_32_64_l [0 : N_COS - 1];
    logic              m_c_32_64_v;
    ...
    logic [128 - 1 : 0] m_c_16_64_m [0 : N_COS - 1];
    logic [768 - 1 : 0] m_c_16_64_l [0 : N_COS - 1];
    logic              m_c_16_64_v;
    ...
    logic [128 - 1 : 0] m_c_8_64_m [0 : N_COS - 1];
    logic [896 - 1 : 0] m_c_8_64_l [0 : N_COS - 1];
    logic              m_c_8_64_v;
    ...
    logic [128 - 1 : 0] m_c_4_64_m [0 : N_COS - 1];
    logic [960 - 1 : 0] m_c_4_64_l [0 : N_COS - 1];
    logic              m_c_4_64_v;
    ...
    logic [128 - 1 : 0] d_16_32_to_16_64_m [0 : N_COS - 1];
    logic [256 - 1 : 0] d_16_32_to_16_64_l [0 : N_COS - 1];
