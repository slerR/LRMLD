module top_32 #(
    ...
    logic [30 - 1 : 0] m_c_0_8_m [0 : N_COS - 1];
    logic [24 - 1 : 0] m_c_0_8_l [0 : N_COS - 1];
    logic              m_c_0_8_v;

    logic [30 - 1 : 0] m_c_8_16_m [0 : N_COS - 1];
    logic [24 - 1 : 0] m_c_8_16_l [0 : N_COS - 1];
    logic              m_c_8_16_v;

    logic [30 - 1 : 0] m_c_16_24_m [0 : N_COS - 1];
    logic [24 - 1 : 0] m_c_16_24_l [0 : N_COS - 1];
    logic              m_c_16_24_v;

    logic [30 - 1 : 0] m_c_24_32_m [0 : N_COS - 1];
    logic [24 - 1 : 0] m_c_24_32_l [0 : N_COS - 1];
    logic              m_c_24_32_v;

    logic [30 - 1 : 0] m_c_0_16_m [0 : N_COS - 1];
    logic [48 - 1 : 0] m_c_0_16_l [0 : N_COS - 1];
    logic              m_c_0_16_v;

    logic [30 - 1 : 0] m_c_16_32_m [0 : N_COS - 1];
