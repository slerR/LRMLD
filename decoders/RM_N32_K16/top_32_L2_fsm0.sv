module top_32 #(
    ...
    logic [20 - 1 : 0] m_c_0_8_m [0 : N_COS - 1];
    logic [16 - 1 : 0] m_c_0_8_l [0 : N_COS - 1];
    logic              m_c_0_8_v;

    logic [20 - 1 : 0] m_c_8_16_m [0 : N_COS - 1];
    logic [16 - 1 : 0] m_c_8_16_l [0 : N_COS - 1];
    logic              m_c_8_16_v;

    logic [20 - 1 : 0] m_c_16_24_m [0 : N_COS - 1];
    logic [16 - 1 : 0] m_c_16_24_l [0 : N_COS - 1];
    logic              m_c_16_24_v;

    logic [20 - 1 : 0] m_c_24_32_m [0 : N_COS - 1];
    logic [16 - 1 : 0] m_c_24_32_l [0 : N_COS - 1];
    logic              m_c_24_32_v;

    logic [20 - 1 : 0] m_c_0_16_m [0 : N_COS - 1];
    logic [32 - 1 : 0] m_c_0_16_l [0 : N_COS - 1];
    logic              m_c_0_16_v;

    logic [20 - 1 : 0] m_c_16_32_m [0 : N_COS - 1];
