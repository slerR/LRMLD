...
HD_PWD='C:/LRMLD/module_library/top_comb/top_comb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_top_comb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_top_comb.tcl
