...
HD_PWD='C:/LRMLD/module_library/top_comb/top_comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_top_comb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_top_comb.tcl -notrace
