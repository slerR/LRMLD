...
HD_PWD='C:/LRMLD/module_library/sum_select_12/sum_select_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SS12_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SS12_wrapper.tcl
