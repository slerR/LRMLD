...
HD_PWD='C:/LRMLD/module_library/sum_select_12/sum_select_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SS12_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SS12_wrapper.tcl -notrace
