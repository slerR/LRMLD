...
HD_PWD='C:/LRMLD/module_library/bitonic_sort/bitonic_sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bitonic_sort_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bitonic_sort_wrapper.tcl -notrace
