...
HD_PWD='C:/LRMLD/module_library/bitonic_sort/bitonic_sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitonic_sort_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitonic_sort_wrapper.tcl
