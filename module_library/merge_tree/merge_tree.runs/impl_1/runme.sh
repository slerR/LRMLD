...
HD_PWD='C:/LRMLD/module_library/merge_tree/merge_tree.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log merge_tree_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source merge_tree_wrapper.tcl -notrace
