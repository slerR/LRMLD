...
HD_PWD='C:/LRMLD/module_library/merge_tree/merge_tree.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log merge_tree_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source merge_tree_wrapper.tcl
