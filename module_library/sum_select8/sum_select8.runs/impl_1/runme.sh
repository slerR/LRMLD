...
HD_PWD='C:/LRMLD/sum_select8/sum_select8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_SS8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_SS8.tcl -notrace
