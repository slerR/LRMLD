...
HD_PWD='C:/LRMLD/sum_select8/sum_select8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_SS8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_SS8.tcl
