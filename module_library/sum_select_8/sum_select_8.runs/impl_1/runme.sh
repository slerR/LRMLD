...
HD_PWD='C:/LRMLD/module_library/sum_select_8/sum_select_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SS8_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SS8_wrapper.tcl -notrace
