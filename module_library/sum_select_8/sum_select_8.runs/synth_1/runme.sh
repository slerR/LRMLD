...
HD_PWD='C:/LRMLD/module_library/sum_select_8/sum_select_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SS8_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SS8_wrapper.tcl
