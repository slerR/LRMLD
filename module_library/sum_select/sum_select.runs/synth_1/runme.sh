...
HD_PWD='C:/LRMLD/sum_select/sum_select.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_SS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_SS.tcl
