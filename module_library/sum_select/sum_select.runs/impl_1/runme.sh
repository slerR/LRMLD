...
HD_PWD='C:/LRMLD/sum_select/sum_select.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_SS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_SS.tcl -notrace
