...
HD_PWD='C:/LRMLD/module_library/table_sort/table_sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log table_sort_wrap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source table_sort_wrap.tcl
