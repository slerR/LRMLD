...
HD_PWD='C:/LRMLD/module_library/table_sort/table_sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log table_sort_wrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source table_sort_wrap.tcl -notrace
