...
HD_PWD='C:/LRMLD/module_library/comb/comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_comb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_comb.tcl -notrace
