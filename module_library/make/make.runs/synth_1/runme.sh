...
HD_PWD='C:/LRMLD/module_library/make/make.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_make.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_make.tcl
