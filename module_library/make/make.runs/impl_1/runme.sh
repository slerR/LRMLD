...
HD_PWD='C:/LRMLD/module_library/make/make.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_make.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_make.tcl -notrace
