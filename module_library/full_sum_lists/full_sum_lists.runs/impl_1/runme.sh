...
HD_PWD='C:/LRMLD/module_library/full_sum_lists/full_sum_lists.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_full_sum_lists.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wp_full_sum_lists.tcl -notrace
