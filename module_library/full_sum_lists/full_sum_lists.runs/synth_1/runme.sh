...
HD_PWD='C:/LRMLD/module_library/full_sum_lists/full_sum_lists.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wp_full_sum_lists.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wp_full_sum_lists.tcl
