...
HD_PWD='C:/LRMLD/module_library/sum_select_16/sum_select_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SS16_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SS16_wrapper.tcl
