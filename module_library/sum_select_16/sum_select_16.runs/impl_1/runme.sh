...
HD_PWD='C:/LRMLD/module_library/sum_select_16/sum_select_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SS16_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SS16_wrapper.tcl -notrace
